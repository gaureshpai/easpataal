                  ...
                  <div className="p-3 bg-blue-50 rounded-lg border text-sm">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div>
                        ...
                        {selectedPatientData.age || "N/A"}
                      </div>
                      <div>
                        <span className="text-blue-700">Gender:</span>{" "}
                        {selectedPatientData.gender || "N/A"}
                      </div>
            ...
            {tokens.length > 0 ? (
                    ...
                    <div className="flex flex-col sm:items-end sm:text-right gap-2 sm:gap-0">
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                          Wait: {token.estimatedWaitTime} min
                        </p>
                        <p className="text-xs text-gray-500">
                          Created:{" "}
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                ...
                                {token.tokenNumber} for {token.patientName}?
              ...
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-gray-600">
                  Please wait, tokens are being fetched...
                </p>
              </div>
            ) : (
              <div className="text-center py-8 text-gray-500">
