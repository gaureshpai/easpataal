...
export default function ReceptionistDashboardContent({
  ...
  const handleUpdateVitals = async (e: React.FormEvent) => {
    ...
    try {
      const result = await updatePatientVitalsAction(
        selectedPatient.id,
        vitalsForm
      );
      ...
      {criticalPatients.length > 0 && (
        <Alert className="border-red-200 bg-red-50">
          ...
          <AlertDescription className="text-red-800">
            <strong>Critical Patients:</strong> {criticalPatients.length}{" "}
        ...
        <TabsContent value="patients" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Monitor and update patient information from database
              </CardDescription>
            </CardHeader>
            <CardContent>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <CardDescription>
                              {patient.age} yrs • {patient.gender} • Bed{" "}
                              {patient.bed}
                            </CardDescription>
                          </div>
                        </div>
      ...
      <Dialog open={isVitalsDialogOpen} onOpenChange={setIsVitalsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Update patient vital signs in the database
            </DialogDescription>
          </DialogHeader>
