...
import {
  getAllCounterCategoriesAction,
  createCounterCategoryAction,
  updateCounterCategoryAction,
  deleteCounterCategoryAction,
} from "@/lib/counter-category-actions";
    ...
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={handleSelectChange("assignedUserId")}
          disabled={isPending}
        >
          <SelectTrigger>
